...
var MAX_CHARS=14;var $div=$('<div>');$div.html(data);var $nameContainer=$div.find('.currency-name-container'),name=$nameContainer.html();name=name.length>MAX_CHARS?name.substr(0,MAX_CHARS-2)+'...':name;$nameContainer.html(name);return $div.html();}
...
var assetTableOptions={"bFilter":false,"bInfo":false,"bLengthChange ":false,"bPaginate":false,"bStateSave":false,"aoColumnDefs":[{"sType":"string","aTargets":[1],"render":constrainName},{"sType":"string","aTargets":[2]},{"sType":"currency","aTargets":[3]},{"sType":"price","aTargets":[4]},{"sType":"volume","aTargets":[5]},{"sType":"totalsupply","aTargets":[6]},{"sType":"percent","aTargets":[7]},{"bSortable":false,"aTargets":[8]},{"asSorting":["desc","asc"],"aTargets":[3,4,5,6,7]},],"language":langOptions};initResponsiveTable('#assets',assetTableOptions,
[0,1,4,7,3,6,5,8,2]);$('#markets-table').dataTable({"bFilter":false,"bInfo":false,"bLengthChange ":false,"bPaginate":false,"bStateSave":false,"aoColumnDefs":[{"sType":"innerstring","aTargets":[1]},{"sType":"innerstring","aTargets":[2]},{"sType":"volume","aTargets":[3]},{"sType":"price","aTargets":[4]},{"sType":"percentformatted","aTargets":[5]},{"sType":"string","aTargets":[6]},{"asSorting":["desc","asc"],"aTargets":[3,4,5]},],"language":langOptions});$('#exchange-markets').dataTable({"bFilter":false,"bInfo":false,"bLengthChange ":false,"bPaginate":false,"bStateSave":false,"aoColumnDefs":[{"sType":"innerstring","aTargets":[1]},{"sType":"innerstring","aTargets":[2]},{"sType":"volume","aTargets":[3]},{"sType":"price","aTargets":[4]},{"sType":"percentformatted","aTargets":[5]},{"sType":"string","aTargets":[6]},{"asSorting":["desc","asc"],"aTargets":[3,4,5]},],"language":langOptions});var currenciesVolume=$('#currencies-volume').DataTable({"bFilter":false,"bInfo":false,"bLengthChange ":false,"bPaginate":false,"bStateSave":false,"aoColumnDefs":[{"sType":"string","aTargets":[1]},{"sType":"string","aTargets":[2]},{"sType":"volume","aTargets":[3]},{"sType":"volume","aTargets":[4]},{"sType":"volume","aTargets":[5]},{"asSorting":["desc","asc"],"aTargets":[3,4,5]},],"order":[],"language":langOptions});$('#trending-recently-added').DataTable({"bFilter":false,"bInfo":false,"bLengthChange ":false,"bPaginate":false,"bStateSave":false,"order":[],"aoColumnDefs":[{"sType":"innerstring","aTargets":[0]},{"sType":"string","aTargets":[1]},{"sType":"percent","aTargets":[2]},{"sType":"currency","aTargets":[3]},{"sType":"price","aTargets":[4]},{"sType":"totalsupply","aTargets":[5]},{"sType":"volume","aTargets":[6]},{"sType":"percent","aTargets":[7]},{"asSorting":["desc","asc"],"aTargets":[3,4,5,6,7]},],"language":langOptions});$('.trending-gainers-table, .trending-losers-table').DataTable({"bFilter":false,"bInfo":false,"bLengthChange ":false,"bPaginate":false,"bStateSave":false,"order":[],"aoColumnDefs":[{"sType":"innerstring","aTargets":[1]},{"sType":"string","aTargets":[2]},{"sType":"volume","aTargets":[3]},{"sType":"price","aTargets":[4]},{"sType":"percent","aTargets":[5]},{"asSorting":["desc","asc"],"aTargets":[3,4,5]},],"language":langOptions});jQuery.extend(jQuery.fn.dataTableExt.oSort,{"totalsupply-pre":function(a){if($(a).data("supply")){a=$(a).data("supply");}
a=parseFloat(a)
if(isNaN(a)){a=-1;}
...
return a;},"percent-asc":function(a,b){return a-b;},"percent-desc":function(a,b){return b-a;}});jQuery.extend(jQuery.fn.dataTableExt.oSort,{"percentformatted-pre":function(a){var $div=$('<div>');$div.html(a);var value=$div.find('[data-format-value]').attr('data-format-value');value=parseFloat(value.replace(/[^\d\-\.]/g,""));if(isNaN(value)){value=-0.0001;}
return value;},"percentformatted-asc":function(a,b){return a-b;},"percentformatted-desc":function(a,b){return b-a;}});jQuery.extend(jQuery.fn.dataTableExt.oSort,{"innerstring-pre":function(a){a=$(a).text();return a;},"innerstring-asc":function(a,b){return a-b;},"innerstring-desc":function(a,b){return b-a;}});});function toggle_currency(currency){var currency_lowercase=currency;var abbreviate=MOBILE.isMobile(); if(currency_lowercase=="btc"){$.each([$('.market-cap'),$('.price'),$('.volume')],function(){selector_type=this.selector
$.each(this,function(key,value){amount=$(this).data("btc");if(amount==="None"){amount="?";}
if(amount!="?"){amount=parseFloat(amount)
if(selector_type==".price"){amount=format_crypto(amount);}else if(selector_type==".volume"){amount=format_crypto_volume(amount,abbreviate);}else{amount=format_market_cap(amount,abbreviate);}}
